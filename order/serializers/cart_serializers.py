...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = (
            'id','client','payment', 'status','tax', 'orderDate', 'total_price','total_products','deliveryCost','price_with_tax', 'price_with_tax_with_coupon','items'
        )       
...
class ProductSerializer(serializers.ModelSerializer):
        ...
        class Meta:
            model = Product
            fields = ('id','image','restaurant_name','category', 'name', 'price', 'offers', 'price_after_offer')
            read_only_fields = ('id', )
